  ...
  return (
    <div className="relative bg-white w-full h-[6273px] overflow-hidden text-justify text-21xl text-teal-100 font-lato">
      ...
      <div className="absolute top-[4300px] left-[169px] w-[1114px] h-[1680px]">
        <img
          className="absolute top-[23px] left-[562px] w-[552px] h-[563px] object-cover"
          alt=""
          src="/imgeste@2x.png"
        />
        <div className="absolute top-[0px] left-[0px] inline-block w-[542px] h-[586px]">
          <p className="m-0 font-extrabold">ESTERILLOS, PACIFIC COAST</p>
          <p className="m-0 font-extrabold">&nbsp;</p>
          <p className="m-0 text-11xl text-black">{`As Matapalo and Pacuare site in Esterillos the main focus of the site is the conservation of sea turtles such as green sea turtles (Chelonia mydas), olive ridley (Lepidochelys kempii), and hawksbill (Eretmochelys imbricata) turtles. `}</p>
          <p className="m-0 text-11xl text-black">
        ...
        <div className="absolute top-[632px] left-[562px] text-13xl inline-block w-[544px]">
          <p className="m-0 font-extrabold">FREE TIME ACTIVITIES</p>
          <p className="m-0 font-extrabold">&nbsp;</p>
      ...
      <div className="absolute top-[2542px] left-[163px] w-[1127px] h-[1672px] text-11xl">
        <div className="absolute top-[1290px] left-[0px] bg-gainsboro w-[1120px] h-[382px]" />
        <div className="absolute top-[693px] left-[575px] inline-block w-[545px]">
          <p className="m-0 font-extrabold">FREE TIME ACTIVITIES</p>
          <p className="m-0 font-extrabold">&nbsp;</p>
          <p className="m-0 text-black">
        ...
        <div className="absolute top-[0px] left-[6px] inline-block w-[539px] h-[677px] text-21xl">
          <p className="m-0 font-extrabold">PACUARE, CARIBBEAN COAST</p>
          <p className="m-0 text-13xl text-black">
        ...
        <div className="absolute top-[683px] left-[6px] inline-block w-[550px]">
          <p className="m-0 font-extrabold">ACCOMMODATIONS</p>
          <p className="m-0 font-extrabold">&nbsp;</p>
          <p className="m-0 font-open-sans-hebrew text-black">
        ...
        <img
          className="absolute top-[23px] left-[575px] w-[552px] h-[596px] object-cover"
          alt=""
          src="/imgpacu@2x.png"
        />
      </div>
      <div className="absolute top-[821px] left-[119px] w-[1164px] h-[1622px] text-11xl">
        <div className="absolute top-[1270px] left-[50px] bg-gainsboro w-[1114px] h-[352px]" />
        <div className="absolute w-[calc(100%_-_552px)] top-[0px] right-[552px] left-[0px] flex flex-row items-start justify-start p-2.5 box-border text-21xl">
          <div className="w-[613px] h-[629px] flex flex-col items-start justify-start py-0 px-[34px] box-border gap-[19px]">
            <div className="relative font-extrabold">
              MATAPALO, PACIFIC COAST
            </div>
            <div className="self-stretch relative text-11xl text-black">
        ...
        <div className="absolute top-[649px] left-[44px] inline-block w-[547px] h-[550px]">
          <p className="m-0 font-extrabold">ACCOMMODATIONS</p>
          <p className="m-0 font-extrabold">&nbsp;</p>
          <p className="m-0 text-black">
            The Matapalo site offers hostel-style accommodations. There are
        ...
        <div className="absolute w-[calc(100%_-_614px)] top-[10px] right-[0px] left-[614px] flex flex-row items-start justify-start">
          <img
            className="flex-1 relative max-w-full overflow-hidden h-[596px] object-cover"
            alt=""
            src="/imgmata@2x.png"
          />
        </div>
        <div className="absolute top-[649px] right-[5px] inline-block w-[541px] h-[606px]">
          <p className="m-0 font-extrabold">FREE TIME ACTIVITIES</p>
          <p className="m-0 font-extrabold">&nbsp;</p>
          <p className="m-0 text-black">
            Saturday afternoons and all day Sunday are free for volunteers to
      ...
      <img
        className="absolute w-[118.04%] top-[0px] right-[-18.04%] left-[0%] max-w-full overflow-hidden h-[748px] object-cover"
        alt=""
        src="/bannerimgprojects@2x.png"
      />
      <div className="absolute top-[631px] right-[134px] font-extrabold text-white text-left inline-block w-[216px] h-[61px] [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)]">
        PROJECTS
      </div>
      <NavHome
        navHomeTop="38px"
